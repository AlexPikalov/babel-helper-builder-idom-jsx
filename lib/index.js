...
exports.default = function (opts) {
    ...
    function buildElementVoid(path) {
        ...
        return t.callExpression(t.identifier('elementVoid'), [t.stringLiteral(openingElement.name.name), t.stringLiteral(path.scope.generateUidIdentifier('voidEl')), t.arrayExpression(attrs.staticAttrs)].concat(_toConsumableArray(attrs.dynamicAttrs)));
    }
